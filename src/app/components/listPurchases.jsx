...
export default function ListPurchases({ purchase, i }) {
  return (
    <tr>
      ...
      <td className="px-4 py-6 text-sm text-gray-800">{purchase.invNumber}</td>
      <td className="px-4 py-6 text-sm text-gray-800">
      ...
      <td className="px-4 py-6 text-sm text-gray-800">
        <InvoiceStatus status={purchase.invoiceStatus} />
      </td>
      <td className="flex item-center px-4 py-6 text-sm text-gray-800">
        <div className="mr-6">
          <svg
            ...
            onClick={() => redirect(`/inventory/purchases/${purchase.id}`)}
          >
            <path
              strokeLinecap="round"
